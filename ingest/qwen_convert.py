...
# Prompt paths (plural: prompts/)
PARA_TO_JSON_PROMPT = BASE_DIR / "prompts" / "para_to_json.txt"
NORMALIZE_PROMPT = BASE_DIR / "prompts" / "normalize_paragraph.txt"
REPAIR_PROMPT = BASE_DIR / "prompts" / "json_repair.txt"
